          ...
          <DesContainer>
            <Des elevation={2}>
              <LogoAligner>
                ...
                <GoldTitle>About this NFT Collection</GoldTitle>
              </LogoAligner>
              <p>10 unique cartoon characters</p>
              <p>Each character represent a member of the some family.</p>
            </Des>
            <Des elevation={2}>
              <LogoAligner>
                <img src="logo.png" alt=""></img>
              ...
              <p>End 2022:Enabling of Play-to-Earn functionalities</p>
            </Des>
          </DesContainer>
        </MintContainer>
      </MainContainer>
